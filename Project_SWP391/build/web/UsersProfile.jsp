                        ...
                        <div class="card-body p-1-9 p-sm-2-3 p-md-6 p-lg-7">
                            <div class="row align-items-center">
                                <div class="col-lg-6 mb-4 mb-lg-0">
                                    <img src="${user.image}" alt="..." style="max-width: 100%; height: auto;">
                                </div>
            ...
            <div class="modal-dialog">
                    ...
                    <div class="modal-body">
                        <form class ="form-signin" action="manage" method="post">
                            ...
                            Avatar: <input value="${user.image}" name="image"  type="text" id="image" class="form-control" placeholder="Avatar" required="" autofocus=""><br/>
    ...
    <!-- success profile -->                            
        <div class="modal fade" id="successchangeProfile" tabindex="-1" aria-labelledby="loginModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                   <div class="modal-header text-center">
                        <h5 class="modal-title text-center" id="loginModalLabel">Profile was changed successfully</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>                                                
                    </div>
                </div>
            </div>
