                                        ...
                                        <c:forEach items="${listChapter}" var="chapter" varStatus="loop">    
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <c:if test="${action eq 'edit'}">   
                                                        <button type="button" class="btn btn-secondary btn-action" data-bs-toggle="modal" data-bs-target="#editChapter${chapter.chapter_id}">Edit</button>
                                    ...
                                    <nav aria-label="Page navigation ">
                                        ...
                                        <ul class="pagination">
                                            ...
                                            <c:forEach begin="1" end="${endPage}" var = "i">
                                                <li class="page-item"><a class="page-link ${i == pageIndex ? 'active':'' }" href="SearchChapter?courseId=${course.course_id}&page=${i}&action=${action}&keywordChapter=${keywordChapter}&status=${status}">${i}</a></li>
                                                </c:forEach>
