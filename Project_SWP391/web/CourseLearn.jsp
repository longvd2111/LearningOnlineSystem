...
<html>
    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row g-0">
                <div class="col-lg-9" ">
                    <video id = "videoDone" width="100%" height="auto" controls="" style="min-height: 90vh" >
                        <source src="video/${lessonContent.content}" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                </div>
                <div class="col-lg-3">

                    <div class="accordion accordion-flush" id="accordionExample" style="max-height: 100vh;">
