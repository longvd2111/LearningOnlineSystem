                        ...
                        <c:forEach items="${listCourse}" var="course">
                            ...
                            <div class="card mb-3" style="height: 152px" >
                                <div class="row ">
                                    ...
                                    <div class="col-md-7 ">
                                        <div class="card-body">
                                            <a href="BlogDetail?courseId=${course.course_id}" style="text-decoration: none"><h5 class="card-title">${course.course_name}</h5></a>
                                            ...
                                            <div class="col-sm-2">
                                                ...
                                                <span><a href="CourseLearn?courseId=${course.course_id}" class="btn btn-outline-primary" style="width: 83px">Learn</a>
                                                    <a href="ShowInformationCourse?courseId=${course.course_id}" class="btn btn-outline-danger" style="width: 83px">Remove</a></span>
                                            </div>
                                </div>
                            </div>
