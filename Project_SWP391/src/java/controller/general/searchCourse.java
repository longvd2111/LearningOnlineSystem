...
public class searchCourse extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String cateIDs = request.getParameter("cateID") == "" ? "0" : request.getParameter("cateID");
        ...
        String filter = request.getParameter("filter") == "" ? "latest" : request.getParameter("filter");
        ...
        sql.append(" offset (").append(pageIndex).append("-1)*").append(pageSize).append(" ROW FETCH NEXT ").append(pageSize).append(" ROWS only;");
        ...
        List<price_package> listPrice = daoPrice.getAllPricePackage();
